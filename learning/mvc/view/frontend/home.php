        ...
        <div class="row">
             ...
             <span  class="visible-xs pull-right" style="font-size:20px;cursor:pointer; padding-right: 10px; padding-top: 8px; color: #FFFFFF;" >      
              <!-- Authentication Links -->
                    ...
                    <a href="#" data-toggle="modal" data-target="#login-modal" style="color:#e67e22;"> Đăng nhập </a>
                     <a class="top-a" href="">Login</a> 
                
                    <a class="top-a" href="" style="color:#c0392b;"><strong> <?php echo $row['name']?></strong></a>
                    <a class="top-a" href=""><i class="fa fa-btn fa-sign-out"></i><small>Thoát</small></a>
          ...
          <div class="collapse navbar-collapse" id="main-mav-top">
            <ul class="nav navbar-nav">
              ...
              <li>
               <a href="" > Tin Tức - Khuyễn Mãi </a>                    
              </li>                                            
            </ul>
             <ul class="nav navbar-nav pull-right">
             <li><a href="">Vào trang quản trị</a></li> 
              <li class="dropdown">
                <a  class="dropdown-toggle" data-toggle="dropdown"> <span class="glyphicon glyphicon-shopping-cart"><span class="badge"></span></span> Giỏ Hàng <b class="caret"></b></a>
                     ...
                     <table class="table table-hover" >
                      ...
                      <tr>
                       ...
                       <tbody>                       
                         ...
                         <tr>
                           <td>  <img class="card-img img-circle" src="" alt="dell"></td>
                           <td>{!!$row->qty!!}</td>
                           <td>{!!$row->name!!}</td>                           
                           <td>{!!$row->price!!} Vnd</td>
                         </tr>                         
